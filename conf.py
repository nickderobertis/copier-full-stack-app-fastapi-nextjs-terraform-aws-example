...
PACKAGE_SHORT_DESCRIPTION = "Example output for copier-full-stack-app-fastapi-nextjs-terraform-aws. See the template at https://github.com/nickderobertis/copier-full-stack-app-fastapi-nextjs-terraform-aws"
